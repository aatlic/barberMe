    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BarberLevelId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarberLevels", x => x.BarberLevelId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    BarberLevelId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_BarberLevels_BarberLevelId",
                        column: x => x.BarberLevelId,
                        principalTable: "BarberLevels",
                        principalColumn: "BarberLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingHours_Users_BarberId",
                        column: x => x.BarberId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecommendationFeedbackId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RecommendationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecommendationFeedbacks", x => x.RecommendationFeedbackId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_Users_BarberId",
                        column: x => x.BarberId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "BarberLevels",
                columns: new[] { "BarberLevelId", "Name" },
                values: new object[,]
                {
                    { 1, "Junior" },
                    { 2, "Senior" },
            ...
            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "ServiceId", "DefaultDurationMinutes", "DefaultPrice", "Description", "Image", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, 30, 25m, "Classic men's haircut.", null, true, "Haircut" },
                    { 2, 20, 15m, "Beard shaping and trimming.", null, true, "Beard Trim" },
                    { 3, 50, 35m, "Haircut with beard trimming and styling.", null, true, "Haircut & Beard" },
                    { 4, 25, 20m, "Haircut for children.", null, true, "Kids Haircut" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "BarberLevelId", "CreatedAt", "Email", "FailedLoginAttempts", "FirstName", "IsActive", "IsLocked", "LastName", "LockedUntil", "PasswordHash", "PhoneNumber", "ProfileImage", "RequirePasswordChange", "RoleId", "Username" },
                values: new object[,]
                {
                    { 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@barberme.com", 0, "Admin", true, false, "Admin", null, "$2a$11$3imUFH1O5lE9g7XuS3hZOOUVPwdRz4yQjbw/4pyzVIeXf/ZHTbBUu", "000000000", null, false, 1, "admin" },
                    { 2, 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "barber@barberme.com", 0, "John", true, false, "Doe", null, "$2a$11$3imUFH1O5lE9g7XuS3hZOOUVPwdRz4yQjbw/4pyzVIeXf/ZHTbBUu", "061111111", null, false, 2, "barber" },
                    { 3, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "client@barberme.com", 0, "Jane", true, false, "Doe", null, "$2a$11$3imUFH1O5lE9g7XuS3hZOOUVPwdRz4yQjbw/4pyzVIeXf/ZHTbBUu", "062222222", null, false, 3, "client" }
                });

            migrationBuilder.InsertData(
                table: "BarberServices",
                columns: new[] { "BarberServiceId", "BarberId", "CreatedAt", "DurationMinutes", "Price", "ServiceId" },
                values: new object[,]
                {
                    { 1, 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 30, 25m, 1 },
                    { 2, 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 20, 15m, 2 },
                    { 3, 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 50, 35m, 3 },
                    { 4, 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 25, 20m, 4 }
                });

            migrationBuilder.InsertData(
                table: "WorkingHours",
                columns: new[] { "WorkingHoursId", "BarberId", "DayOfWeek", "EndTime", "IsWorking", "StartTime" },
                values: new object[,]
                {
                    { 1, 2, 1, new TimeSpan(0, 18, 0, 0, 0), true, new TimeSpan(0, 10, 0, 0, 0) },
                    { 2, 2, 2, new TimeSpan(0, 18, 0, 0, 0), true, new TimeSpan(0, 10, 0, 0, 0) },
                    { 3, 2, 3, new TimeSpan(0, 18, 0, 0, 0), true, new TimeSpan(0, 10, 0, 0, 0) },
                    { 4, 2, 4, new TimeSpan(0, 18, 0, 0, 0), true, new TimeSpan(0, 10, 0, 0, 0) },
                    { 5, 2, 5, new TimeSpan(0, 18, 0, 0, 0), true, new TimeSpan(0, 10, 0, 0, 0) },
                    { 6, 2, 6, new TimeSpan(0, 14, 0, 0, 0), true, new TimeSpan(0, 10, 0, 0, 0) },
                    { 7, 2, 7, new TimeSpan(0, 0, 0, 0, 0), false, new TimeSpan(0, 0, 0, 0, 0) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_BarberId_StartDateTime_EndDateTime",
                table: "Appointments",
                columns: new[] { "BarberId", "StartDateTime", "EndDateTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_BarberLevelId",
                table: "Users",
                column: "BarberLevelId");
