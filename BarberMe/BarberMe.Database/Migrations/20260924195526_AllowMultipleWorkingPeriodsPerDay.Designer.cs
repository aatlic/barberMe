...
namespace BarberMe.Database.Migrations
{
    ...
    [Migration("20260924195526_AllowMultipleWorkingPeriodsPerDay")]
    partial class AllowMultipleWorkingPeriodsPerDay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarberMe.Database.Models.Appointment", b =>
                {
                    ...
                    b.Property<decimal>("AppliedPenaltyPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("BarberMe.Database.Models.Recommendation", b =>
                {
                    ...
                    b.HasIndex("UserId", "BarberServiceId", "CreatedAt");

                    b.ToTable("Recommendations", t =>
                        {
                            t.HasCheckConstraint("CK_Recommendation_Score", "[Score] >= 0 AND [Score] <= 1");
                        });
                });
            ...
            modelBuilder.Entity("BarberMe.Database.Models.ShopSettings", b =>
                {
            ...
            modelBuilder.Entity("BarberMe.Database.Models.User", b =>
                {
                    ...
                    b.Property<bool>("HasNoShowPenalty")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
