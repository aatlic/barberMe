...
import '../client/change_password_screen.dart';
...
class BarberProfileScreen extends StatefulWidget {
  ...
  @override
  State<BarberProfileScreen> createState() =>
      _BarberProfileScreenState();
}

class _BarberProfileScreenState
    extends State<BarberProfileScreen> {
  ...
  Widget _buildBarberInformation(
    User user,
  ) {
    final barberLevel =
        user.barberLevel;
